                ...
                EventBus.on('navigateToSecondaryAnalysis', function(data) {
                    ...
                    if (currentHistoryItem) {
                        ...
                        if (originalTextContent) {
                            originalTextContent.textContent = currentHistoryItem.originalText || '';
                        }
                        
                        if (secondaryFullTranslationText) {
                            secondaryFullTranslationText.textContent = currentHistoryItem.fullTranslation || '';
                        }
                    }
                });
